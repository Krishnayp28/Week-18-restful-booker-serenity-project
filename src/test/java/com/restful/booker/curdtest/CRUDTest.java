...
import com.restful.booker.restfilonfo.CreateSteps;
import com.restful.booker.restfilonfo.DeleteSteps;
import com.restful.booker.restfilonfo.ReadSteps;
import com.restful.booker.restfilonfo.UpdateSteps;
...
public class CRUDTest extends TestBase {
    ...
    static String firstname = "Jigna" + TestUtils.getRandomValue();
    static String lastname = "Patel";
    static int totalprice = 798;
